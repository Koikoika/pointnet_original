...
DATA_PATH = os.path.join(ROOT_DIR, 'data', 'dso_dataset')
...
def point_label_to_obj(input_filename, out_filename, label_color=True, easy_view=True, no_wall=False):
...
def bbox_label_to_obj(input_filename, out_filename_prefix, easy_view=True):
...
def bbox_label_to_obj_room(input_filename, out_filename_prefix, easy_view=True, permute=None, center=False, exclude_table=False):
    """ Visualization of bounding boxes.
